...
typedef struct private_fsm_updown_handler_t private_fsm_updown_handler_t;

/**
 * Private data of an fsm_updown_handler_t object.
 */
struct private_fsm_updown_handler_t {

	/**
	 * Public fsm_updown_handler_t interface.
	 */
	fsm_updown_handler_t public;
...
METHOD(attribute_handler_t, handle, bool,
	private_fsm_updown_handler_t *this, ike_sa_t *ike_sa,
...
METHOD(fsm_updown_handler_t, destroy, void,
	private_fsm_updown_handler_t *this)
{
