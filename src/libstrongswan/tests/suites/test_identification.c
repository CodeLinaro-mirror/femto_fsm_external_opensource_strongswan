...
START_TEST(test_matches_regex)
{
	...
	/* internal buffer for matched identities is BUF_LEN-1 */
	a = identification_create_from_string("@strongswan.org");
	ck_assert(regex_matches(a, "email:^.*@strongswan.org$", ID_MATCH_MAX_WILDCARDS));
	a->destroy(a);

	a = identification_create_from_string("@strongswan.org");
	ck_assert(regex_matches(a, "email:^.*@strongswan.org$", ID_MATCH_NONE));
	a->destroy(a);
}
END_TEST
